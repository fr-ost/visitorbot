<title>Auto Visitor For All</title>
                ...
                @import "http://fonts.googleapis.com/css?family=Play:400,700";
					   ...
					   .text-glow a {
                        ...
                        body {
                                ...
                                font-size: 12px;
                                background:#F6FBEEurl(bg.jpg) no-repeat center center fixed;
...
<center><div class="panel panel-primary panelMove toggle panelRefresh panelClose">
                                    ...
                                    <div class="panel-heading">
                                        <hr />
                                        <h4 class="panel-title"><font color="Red" face="Pristina" size="4" >Auto Visitor<br/>অতিরিক্ত কোন কিছুই ভাল না।<br/>লোভে পাপ,পাপে মৃত্যু।<br/><a href="http://fb.me/ig.Frostt">Any Question?(Facebook)</a>
                                        <hr />
                                    </div>
...
<input type="text" name="url" value="https://YourBloggerLink.Com">
<input type="max" name="max" value="1000"> 
<input type="submit">
<center></form></br>
<font face="Ubuntu" color="green" size="4px">
<?php
if (!$_GET) die();
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". SUCCESSFUL - [".$class->jalankan()."]<br>";
}
?>
